"""Routes et dépendances pour l'authentification."""
...
def ensure_default_user() -> None:
    ...
    default_password = os.getenv("DEFAULT_ADMIN_PASSWORD", "Nidec2025!")

    if get_user_by_username(default_username):
        return

    password_hash = get_password_hash(default_password)
    create_user(default_username, password_hash, is_active=True)
